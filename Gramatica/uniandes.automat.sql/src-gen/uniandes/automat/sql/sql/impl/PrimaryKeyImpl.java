 ...
 * </p>
 * <ul>
 *   <li>{@link uniandes.automat.sql.sql.impl.PrimaryKeyImpl#getCol <em>Col</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrimaryKeyImpl extends MinimalEObjectImpl.Container implements PrimaryKey
{
  ...
  public EList<Column> getCol()
  {
    if (col == null)
    {
      col = new EObjectResolvingEList<Column>(Column.class, this, SqlPackage.PRIMARY_KEY__COL);
    }
    return col;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SqlPackage.PRIMARY_KEY__COL:
        return getCol();
    }
